...
- (void)viewDidLoad
{
    ...
    _petYields = @[
                ...
                d   @{@"display":@"400 ga\t\t\t101.60 mic", @"gauge":@400.00,	@"mic":@101.60,	@"in":@4901.00,      @"ft":@34.40,        @"yd":@3.80,       @"m":@7.00},
    ...
    */
    ...
    _petYields = @[
           @{@"display":@"1 ga\t\t\t\t.01 mil", @"gauge":@1.00,	@"mic":@0.25,   @"in":@1980198.00,	 @"ft":@13751.40,     @"yd":@1527.90,    @"m":@2816.50},
           @{@"display":@"48 ga\t\t\t\t.48 mil", @"gauge":@48.00,	@"mic":@12.19,	@"in":@41254.00,     @"ft":@286.50,       @"yd":@31.80,      @"m":@58.70},
           @{@"display":@"60 ga\t\t\t\t.60 mil", @"gauge":@60.00,	@"mic":@15.24,	@"in":@33003.00,     @"ft":@229.20,       @"yd":@25.50,      @"m":@46.90},
           @{@"display":@"75 ga\t\t\t\t.75 mil", @"gauge":@75.00,	@"mic":@19.05,	@"in":@26403.00,     @"ft":@183.40,       @"yd":@20.40,      @"m":@37.60},
           @{@"display":@"92 ga\t\t\t\t.92 mil", @"gauge":@92.00,	@"mic":@23.37,	@"in":@21524.00,     @"ft":@149.50,       @"yd":@16.60,      @"m":@30.60},
           @{@"display":@"142 ga\t\t\t1.42 mil", @"gauge":@142.00,	@"mic":@36.07,	@"in":@13945.00,     @"ft":@96.80,        @"yd":@10.80,      @"m":@19.80},
           @{@"display":@"200 ga\t\t\t2 mil", @"gauge":@200.00,	@"mic":@50.80,	@"in":@9901.00,      @"ft":@68.80,        @"yd":@7.60,       @"m":@14.10},
           @{@"display":@"300 ga\t\t\t3 mil", @"gauge":@300.00,	@"mic":@76.20,	@"in":@6601.00,      @"ft":@45.80,        @"yd":@5.10,       @"m":@9.40},
           @{@"display":@"400 ga\t\t\t4 mil", @"gauge":@400.00,	@"mic":@101.60,	@"in":@4901.00,      @"ft":@34.40,        @"yd":@3.80,       @"m":@7.00},
           @{@"display":@"500 ga\t\t\t5 mil", @"gauge":@500.00,	@"mic":@127.00,	@"in":@3960.00,      @"ft":@27.50,        @"yd":@3.10,       @"m":@5.60},
           @{@"display":@"700 ga\t\t\t7 mil", @"gauge":@700.00,	@"mic":@177.80,	@"in":@2829.00,      @"ft":@19.60,        @"yd":@2.20,       @"m":@4.00},
           ];
