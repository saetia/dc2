...
- (RETableViewSection *)addBasicControls {
    ...
    RETableViewSection *section = [RETableViewSection sectionWithHeaderTitle:@"Roll Diameter"];
...
- (void)calculateResult:(UITextField *)sender {
    ...
    if (filled_out_fields >= required_fields){
        ...
        total = sqrt((15.279f * value1) * value2 + pow(value3, 2.0f));
        //=SQRT((((15.279*B13)*C13)+(D13^2)))
